...
class students(db.Model):
    ...
    att1=db.relationship('attendance',backref='Students')
    ...
    def __repr__(self):
        return f"usn of student:{self.usn},Name of student: {self.name},    Semester: {self.sem}, Department: {self.dept}, student phno: {self.st_phno}, parent phno: {self.pa_phno} "
...
class teacher(db.Model):
    ...
    tc1=db.relationship('subject',backref='Teacher')
